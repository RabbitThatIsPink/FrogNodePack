...
A resolution picker with presets sized for SDXL and similar models. Choose from the dropdown and get a latent tensor ready to go, plus the width and height as integers — handy for wiring into conditioning nodes that need size information.
